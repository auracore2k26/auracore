        ...
        <form id="trainer-form">
          ...
          <div class="form-group">
            ...
            <select id="trn-specialty" class="form-control">
              <option value="Personal Fitness & Body Transformation">Personal Fitness & Body Transformation</option>
              <option value="Weight Loss & Functional Fitness">Weight Loss & Functional Fitness</option>
              <option value="Strength & Conditioning">Strength & Conditioning</option>
              <option value="Special Care & Mobility Training">Special Care & Mobility Training</option>
            </select>
          </div>
          <div class="form-group">
